...
public class DriverLoginActivity extends AppCompatActivity {
    ...
    private final static String debugDriverEmail = "driver@driver.com";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m_authListner = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(user != null)
                {
                    Intent driverLoginIntent = new Intent(DriverLoginActivity.this, DriverMapsActivity.class);
        ...
        m_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String email = debugDriverEmail;//m_email.getText().toString();
                String password = debugPassword;//m_passowrd.getText().toString();

                m_auth.signInWithEmailAndPassword(email, password).addOnCompleteListener(DriverLoginActivity.this, new OnCompleteListener<AuthResult>() {
                    @Override
        ...
        m_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final Task<AuthResult> authResultTask = m_auth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(DriverLoginActivity.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (!task.isComplete())
                        {
                        ...
                        else if (task.isSuccessful())
                        {
                            ...
                            DatabaseReference databaseref = FirebaseDatabase.getInstance().getReference().child("Users").child("Drivers").child(userID);
